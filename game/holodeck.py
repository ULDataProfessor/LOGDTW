...
class HolodeckSystem:
    ...
    def start_program(self, player: Player, program_name: str) -> Dict:
        ...
        if player.credits < program.cost:
            return {'success': False, 'message': f'Not enough credits. Need {program.cost}, have {player.credits}'}
        ...
        return {
            'success': True,
            'message': f'Starting {program.name}...',
            'program': program
        }
    ...
    def end_program(self, player: Player) -> Dict:
        ...
        return {
            'success': True,
            'message': f'Ended {program.name} early'
        }
