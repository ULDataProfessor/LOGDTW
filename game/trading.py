...
class TradingSystem:
    ...
    def _create_trade_goods(self):
        ...
        goods_data = [
            ...
            },
            {
                "name": "Platinum",
                "base_price": 200,
                "description": "Rare industrial metal",
                "category": "minerals",
            },
            {
                "name": "Uranium",
            ...
            },
            {
                "name": "Ammolite",
                "base_price": 350,
                "description": "Rare iridescent gemstone prized by collectors and jewelers",
                "category": "minerals",
            },
            # Technology
            {
            ...
            },
            {
                ...
                "base_price": 250,
                "description": "Advanced computing units",
                "category": "technology",
            },
            {
                "name": "Energy Cells",
                "base_price": 25,
                "description": "Power storage units",
                "category": "technology",
            },
            {
                "name": "Shield Generators",
                "base_price": 300,
                "description": "Defensive technology",
                "category": "technology",
            },
            {
                "name": "Quantum Scanner",
                "base_price": 400,
                "description": "Advanced detection device",
                "category": "technology",
            },
            # Luxury Goods
            {
                "name": "Space Wine",
                "base_price": 150,
                "description": "Fine alcoholic beverage",
                "category": "luxury",
            },
            {
                "name": "Alien Artifacts",
                "base_price": 800,
                "description": "Mysterious alien objects",
                "category": "luxury",
            },
            {
                "name": "Rare Gems",
            ...
            },
            {
                "name": "Stolen Cargo",
                "base_price": 300,
                "description": "Questionable goods",
                "category": "luxury",
            },
            # Food
            {
            ...
            },
            {
                ...
                "base_price": 20,
                "description": "Grown on hydroponic farms",
                "category": "food",
            },
            {
                "name": "Exotic Spices",
                "base_price": 75,
                "description": "Rare flavorings",
                "category": "food",
            },
            # Medical
            {
            ...
            # Research
            {
                "name": "Research Data",
                "base_price": 500,
                "description": "Valuable scientific information",
                "category": "research",
            },
            {
                "name": "Experimental Weapon",
                "base_price": 600,
                "description": "Prototype energy weapon",
                "category": "technology",
            },
            {
                "name": "Smuggler's Map",
                "base_price": 80,
                "description": "Shows secret routes",
                "category": "equipment",
            },
        ]
            ...
            goods.append(
                {
                    ...
                    "price": price,
                    "description": (
                        self.trade_goods[good_name].description
                        if good_name in self.trade_goods
                        else ""
                    ),
                    "category": (
                        self.trade_goods[good_name].category
                        if good_name in self.trade_goods
                        else ""
                    ),
                }
    ...
    def _record_trade(
        self, trade_type: str, location: str, item_name: str, quantity: int, amount: int
    ):
