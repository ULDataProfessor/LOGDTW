...
class ShipCounselor:
    ...
    def _generate_helpful_response(self, input_text: str, player_context: Dict = None) -> CounselorResponse:
    ...
    def _generate_general_response(self, input_text: str, player_context: Dict = None) -> CounselorResponse:
