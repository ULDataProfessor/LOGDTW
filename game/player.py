...
class Player:
    ...
    def __init__(self, name: str = "Captain"):
        ...
        # Equipment
        self.equipped = {"weapon": None, "armor": None, "shield": None, "accessory": None}
    ...
    def hire_crew_member(
        self, name: str, role: str = "unassigned", skills: Optional[Dict[str, int]] = None
    ) -> CrewMember:
    ...
    def get_cargo_summary(self) -> Dict:
        ...
        summary = {"total_items": 0, "total_value": 0, "holds": []}
